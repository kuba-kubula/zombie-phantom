...
var Zombie = function(options, callback) {
  ...
  this.settings = options.settings || { 'userAgent': 'Zombie-PhantomJS' };
...
Zombie.prototype._initializePage = function(page, callback) {
  page.evaluate(function() {
    ...
    window.phQuery = function(selector, context) {
      ...
      var query = (context || document).querySelectorAll(selector);
      query.phNodes = [];
      query.each(function() {
      ...
      inst.createPage(function(error, page) {
        if (DEBUG) {
          page.onConsoleMessage = function(msg) {
            console.log('Zombie-Phantom: ' + msg);
          };
        }
        ...
        self.page = page;
        self.page.set('settings', self.settings, function(error) {
...
Zombie.prototype.evaluate = function(expression, callback) {
  this._getPage(function(page) {
    page.evaluate(expression, function(err) {
